...
public class NoticeMessageVo {
	...
	public NoticeMessageVo(String msg_content, String msg_sender, String msg_receiver) {
		super();
	...
	public String toString() {
		return "NoticeMessageVo [msg_no=" + msg_no + ", msg_content=" + msg_content + ", msg_sender=" + msg_sender
