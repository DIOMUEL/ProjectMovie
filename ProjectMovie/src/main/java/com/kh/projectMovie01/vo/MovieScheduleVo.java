...
public class MovieScheduleVo {
	...
	public String toString() {
		return "MovieScheduleVo [movieschedule_recoding=" + movieschedule_recoding + ", area_theater_no="
				+ area_theater_no + ", theater_no=" + theater_no + ", movieSchedule_type=" + movieSchedule_type
				+ ", movie_name=" + movie_name + ", movieSchedule_playTime=" + movieSchedule_playTime
				+ ", movieSchedule_totalPlayTime=" + movieSchedule_totalPlayTime + ", movieSchedule_seat="
				+ movieSchedule_seat + ", movieSchedule_count=" + movieSchedule_count + ", movieSchedule_registTime="
				+ movieSchedule_registTime + "]";
	}
