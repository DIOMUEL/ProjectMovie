...
public class ReportVo {
	...
	public ReportVo(int rpt_no, String rpt_content, String rpt_sender, String rpt_receiver, Timestamp rpt_senddate,
			Timestamp rpt_opendate, int rpt_c_no, int b_no) {
		super();
		this.rpt_no = rpt_no;
