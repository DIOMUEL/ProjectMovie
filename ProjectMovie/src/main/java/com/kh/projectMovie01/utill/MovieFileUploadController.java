...
public class MovieFileUploadController {
	...
	public String fileUpload(MultipartFile file) throws Exception {
		String uploadPath = UploadPath + "/upload";
		String oFileName = file.getOriginalFilename();
		String dirPath = MovieFileUploadUtil.uploadFile(uploadPath, oFileName, file.getBytes());
...
//		String uploadPath = UploadPath + "/upload";
//		String oFileName = file.getOriginalFilename();
//		String dirPath = MovieFileUploadUtil.uploadPreviewFile(uploadPath, oFileName, file.getBytes());
//		return dirPath.replace("\\","/");
//	}
