								...
								<div class="row">
									...
									<div class="col-12">
										<div class="form-group">
											...
											<input name="user_id" id="user_id" type="text" value="${memberVo.user_id}" >
										</div>
									</div>
									<div class="col-12">
										<div class="form-group">
											<label for="user_pw">패스워드:<span></span></label>
											<input name="user_pw" id="user_pw" type="text" >
										</div>
									</div>
									<div class="col-12">
										<div class="form-group">
											<label for="user_name">이름:<span></span></label>
											<input name="user_name" id="user_name" type="text" value="${memberVo.user_name}" >
										</div>
									</div>
									...
									<div class="col-12">
										<div class="form-group">
											...
											<input name="user_point" id="user_point" type="text" value="" >
										</div>
									</div>
