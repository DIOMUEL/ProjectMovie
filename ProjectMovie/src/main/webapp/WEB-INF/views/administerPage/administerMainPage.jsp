...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion"
			id="accordionSidebar">
			<!-- Sidebar - Brand -->
			<a class="sidebar-brand d-flex align-items-center justify-content-center" href="/administerMainPage">
					...
					<ul class="navbar-nav ml-auto">
							...
							<div
								...
								<a class="dropdown-item d-flex align-items-center" href="#">
									<div class="dropdown-list-image mr-3">
										<img class="rounded-circle" src=".././resources/administerPage/img/undraw_profile_1.svg"
											alt="...">
									...
									<div class="dropdown-list-image mr-3">
										<img class="rounded-circle" src=".././resources/administerPage/img/undraw_profile_2.svg"
											alt="...">
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false"> <span
								...
								src=".././resources/administerPage/img/undraw_profile.svg">
								...
								<div class="card-body">
									<div class="text-center">
										<img class="img-fluid px-3 px-sm-4 mt-3 mb-4"
											style="width: 25rem;" src=".././resources/administerPage/img/undraw_posting_photo.svg"
											alt="...">
									</div>
									<p>
